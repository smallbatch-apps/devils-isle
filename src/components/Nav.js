...
const Nav = props => {
  ...
  return <div className="bg-orange w-full feature">
    <div className="flex mx-auto w-4/5 uppercase tracking-wide">
      <div className="flex-1 text-4xl p-2">
        Devil's Isle
      </div>
      <NavLink to="/" exact className="flex-shrink p-5 hover:bg-orange-dark text-white no-underline"
        activeClassName="bg-orange-dark">Home</NavLink>
      <NavLink to="/about" className="flex-shrink p-5 hover:bg-orange-dark text-white no-underline"
